...
import { login, register, User } from "../store"
    ...
    <div className="min-h-screen bg-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-surface border border-border rounded-2xl p-8 shadow-2xl">
          {/* Mode tabs */}
          <div className="flex gap-1 bg-bg rounded-xl p-1 mb-8">
          ...
          {mode === "login" && (
            <div className="mt-6 bg-bg rounded-xl px-4 py-3 border border-border">
              <p className="text-xs text-muted font-mono text-center mb-1">Demo credentials</p>
              <div className="flex justify-center gap-6 text-xs font-mono">
                <span>
                  <span className="text-accent">reader1 / pass123</span>
                </span>
              </div>
            </div>
          )}
