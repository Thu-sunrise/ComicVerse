...
const INITIAL_INTERACTIONS: Record<string, Interactions> = {
  c1: {
    ...
    comments: [
      ...
      { id: "cm2", userId: "u2", username: "reader2", text: "The pacing in this arc is masterful.", timestamp: Date.now() - 3600000 * 5 },
    ],
  },
  c2: {
    views: 934,
